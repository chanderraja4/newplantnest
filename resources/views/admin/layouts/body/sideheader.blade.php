    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav ">
        ...
        <li class="nav-item mt-3  text-dark">
          <h6 class="ps-4 ms-2 text-uppercase text-xs text-dark font-weight-bolder opacity-8">About Page</h6>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark " href="pages/profile.html">
            ...
            <span class="nav-link-text ms-1 text-dark">Images</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark " href="pages/profile.html">
            ...
            <span class="nav-link-text ms-1 text-dark">Description</span>
          </a>
        </li>
        <li class="nav-item mt-3  text-dark">
          <h6 class="ps-4 ms-2 text-uppercase text-xs text-dark font-weight-bolder opacity-8">Blog page</h6>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark " href="pages/profile.html">
            <div class="text-drk text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1 text-dark">Blogs</span>
          </a>
        </li>
        <li class="nav-item mt-3  text-dark">
          <h6 class="ps-4 ms-2 text-uppercase text-xs text-dark font-weight-bolder opacity-8">Contact pages</h6>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark " href="pages/profile.html">
            <div class="text-drk text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1 text-dark">Contact us</span>
          </a>
        </li>
        <li class="nav-item mt-3  text-dark">
